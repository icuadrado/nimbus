...
public class DefaultCancelSIAN implements CancelSIAN {
    ...
    private static final Log logger =
            LogFactory.getLog(DefaultCancelSIAN.class.getName());    

    // -------------------------------------------------------------------------
    // BACKOUT
    // -------------------------------------------------------------------------

    public void backOutRequestSpotInstances(SpotANRequestInfo result,
                                    Caller caller,
                                    Manager manager) {
        ...
        try {
            ...
            final String msg = "Problem backing out SIAN request: " + result.getRequestID() + ": ";
    ...
    public CancelSpotInstanceRequestsResponseType cancelSIRequests(CancelSpotInstanceRequestsType req,
        ...
        try {
            spotRequests = manager.cancelSpotANInstanceRequests(reqIds, caller);
        ...
        if(spotRequests != null){
            ...
            for (int i = 0; i < spotRequests.length; i++) {
                SpotANRequestInfo info = spotRequests[i];
