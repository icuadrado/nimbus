 ...
 * distributed under the License is distributed on an "AS IS" BASIANS, WITHOUT
...
import org.nimbustools.messaging.gt4_0_elastic.v2008_05_05.rm.CancelSIAN;
...
import org.nimbustools.messaging.gt4_0_elastic.v2008_05_05.rm.DescribeSIAN;
...
public class DefaultRequestSIAN extends DefaultRun implements RequestSI {
    ...
    private static final Log logger =
            LogFactory.getLog(DefaultRequestSIAN.class.getName());
        
    protected final MetadataServer mdServer;
    protected final DescribeSIAN describeSI;
    protected final CancelSIAN cancelSI;
    
    // -------------------------------------------------------------------------
    // CONSTRUCTORS
    // -------------------------------------------------------------------------

    public DefaultRequestSIAN(ResourceAllocations rasImpl,
                            Networks networksImpl,
                            Repository repoImpl,
                            IDMappings idsImpl,
                            Describe describeImpl,
                            DescribeSIAN describeSIImpl,
                            CancelSIAN cancelSIIMpl,
        ...
        if (describeSIImpl == null) {
            throw new IllegalArgumentException("describeSIANImpl may not be null");
        }
     ...
     */
    public SpotANCreateRequest translateReqSpotInstances(
        ...
        final Long advanceNotice;
        /*try{
            advanceNotice = new Long(req.getAdvanceNotice());
        } catch (NumberFormatException e){
            throw new RemoteException("Error in advanceNotice conversion.");
        } */   
        
        boolean persistent = DefaultDescribeSIAN.PERSISTENT.equalsIgnoreCase(req.getType());
        ...
        screq.setAdvanceNotice((long) 0); //TODO
